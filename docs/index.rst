...
If the `track_property_modifications` configuration option is set to True, Continuum also creates a boolean field for each versioned field. By default these boolean fields are suffixed with '_mod'.
